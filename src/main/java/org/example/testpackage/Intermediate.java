...
public class Intermediate {
    ...
    public static void main(String[] args) {
        ...
        System.out.println( sentence.split("\\s+")); // hashcode [Ljava.lang.String;@3feba861

        String[] words = sentence.split("\\s+");

        System.out.println(Arrays.toString(words));

        System.out.println(words);   // to string of words  of an array
...
//                .filter(e -> e.getValue() > 1)  // Filter for elements that occur more than once
        ...
        boolean isPalindrome = s.equals(
                ...
                Arrays.stream(s.split("")) //madammadam
...
System.out.println("naturalorder" );
        ...
        list2.stream().sorted(Comparator.naturalOrder())
         .forEach(System.out::println);
